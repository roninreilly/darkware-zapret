...
**Darkware Zapret** — нативное macOS приложение в меню-баре для обхода DPI блокировок. Обёртка над [zapret](https://github.com/bol-van/zapret) с простым интерфейсом "в один клик".
...
- ⚠️ Discord голосовые звонки могут не работать (используют UDP, который tpws не обрабатывает)
- ⚠️ На некоторых провайдерах может потребоваться другая стратегия
